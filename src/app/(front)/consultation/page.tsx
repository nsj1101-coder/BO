...
export default function ConsultationPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      fetch("/api/form-configs/consultation").then((r) => r.json()).catch(() => []),
    ]).then(([sections, fc]) => {
      ...
      <div style={{ background: "#fff", minHeight: "60vh", fontFamily: "'Pretendard',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif" }}>
        <div style={{ maxWidth: 520, margin: "0 auto", padding: "60px 24px 80px" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <h1 style={{ fontSize: 28, fontWeight: 700, color: "#191f28", margin: 0, letterSpacing: "-0.5px" }}>상담 신청</h1>
            <p style={{ fontSize: 15, color: "#8b95a1", marginTop: 8, lineHeight: 1.5 }}>아래 내용을 작성해 주시면 빠르게 연락드리겠습니다</p>
          </div>
          ...
          {success ? (
            <div style={{ textAlign: "center", padding: "60px 0" }}>
              ...
              <h2 style={{ fontSize: 22, fontWeight: 700, color: "#191f28", margin: 0 }}>상담 신청이 완료되었습니다</h2>
              <p style={{ fontSize: 15, color: "#8b95a1", marginTop: 12, lineHeight: 1.5 }}>빠른 시일 내에 연락드리겠습니다.</p>
              <a href="/" style={{
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                {fields.length === 0 && (
                  <p style={{ textAlign: "center", color: "#8b95a1", fontSize: 14 }}>등록된 상담 양식이 없습니다.</p>
                )}
